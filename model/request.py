...
class ApiRequest:
    ...
    def __init__(self, category):
        ...
        self.url = f"""https://fr.openfoodfacts.org/
                    categorie/{self.category}.json"""
    ...
    def request(self):
        ...
        self.request = requests.get("https://fr.openfoodfacts.org"
                                    "/cgi/search.pl?", params=payload)
        ...
        for product in self.products:
            ...
            self.liste_prod.append([self.code, self.name, self.nutriscore,
                                    self.url_prod, self.stores,
                                    self.category])
